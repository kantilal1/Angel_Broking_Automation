...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener {
    ...
    public void onFinish(ITestContext context) {
        ...
        // System.out.println("Generated Report. . .1" + ExtentReportListener.reportPath);
        // SimpleEmailold.mailDetail(ExtentReportListener.reportPath);
        extent.flush();
        System.out.println("Generated Report. . ." + ExtentReportListener.reportPath);
        // SimpleEmailold.mailDetail(ExtentReportListener.reportPath);
    }
